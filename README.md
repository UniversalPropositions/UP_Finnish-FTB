...
- `git clone https://github.com/UniversalPropositions/UP_Finnish-FTB.git`
...
- `python3 up2/merge_ud_up.py --input_ud=<ud_path_to_UD_Finnish-FTB>/ --input_up=<up_path_to_UP_Finnish-FTB>/ --output=<path_to_UD+UP_Finnish-FTB>/`
